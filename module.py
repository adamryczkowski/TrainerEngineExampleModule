...
def randomize_question(positive_skills: list[str], negative_skills: list[str],
                       settings: Settings) -> Optional[tuple[QuestionType, AnswerType, list[str]]]:
    ...
    assert not (set(positive_skills) & set(
...
def check_answer(question: QuestionType, answer: AnswerType, correct: AnswerType, skills: list[str]) -> JudgmentType:
